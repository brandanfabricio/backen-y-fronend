...
mongoose.connect('mongodb+srv://fabriciobrandan:fabricio149@cluster0.2ik5c.mongodb.net/pruebas?retryWrites=true&w=majority',{useNewUrlParser : true})
...
[
   ...
   Tecnologia.create(tecnologia).then(()=>{
     console.log('Tecnologia creadas');
     mongoose.disconnect();
   }).catch(console.log);